...
import {query, QUERY, QUERY_CREATE, QUERY_RESULT, LAYER_SELECTED_FOR_SEARCH, FEATURE_TYPE_LOADED, UPDATE_QUERY, featureTypeSelected, createQuery, updateQuery, TOGGLE_SYNC_WMS, QUERY_ERROR, FEATURE_LOADING} from '../actions/wfsquery';
import {reset, QUERY_FORM_SEARCH, loadFilter} from '../actions/queryform';
import {zoomToExtent} from '../actions/map';


import { BROWSE_DATA, changeLayerProperties, refreshLayerVersion, CHANGE_LAYER_PARAMS} from '../actions/layers';


import {SORT_BY, CHANGE_PAGE, SAVE_CHANGES, SAVE_SUCCESS, DELETE_SELECTED_FEATURES, featureSaving, changePage,
    saveSuccess, saveError, clearChanges, setLayer, clearSelection, toggleViewMode, toggleTool,
    CLEAR_CHANGES, START_EDITING_FEATURE, TOGGLE_MODE, MODES, geometryChanged, DELETE_GEOMETRY, deleteGeometryFeature as deleteGeometryFeatureAction,
    ...
    STOP_SYNC_WMS, startSyncWMS, storeAdvancedSearchFilter, fatureGridQueryResult, LOAD_MORE_FEATURES, SET_TIME_SYNC } from '../actions/featuregrid';

import {TOGGLE_CONTROL, resetControls, setControlProperty, toggleControl} from '../actions/controls';
import {queryPanelSelector, showCoordinateEditorSelector, drawerEnabledControlSelector} from '../selectors/controls';
import {setHighlightFeaturesPath as setHighlightFeaturesPathAction} from '../actions/highlight';
import {selectedFeaturesSelector, changesMapSelector, newFeaturesSelector, hasChangesSelector, hasNewFeaturesSelector,
    selectedFeatureSelector, selectedFeaturesCount, selectedLayerIdSelector, isDrawingSelector, modeSelector,
    isFeatureGridOpen, timeSyncActive, hasSupportedGeometry, queryOptionsSelector, getAttributeFilters } from '../selectors/featuregrid';
import {error, warning} from '../actions/notifications';
import {describeSelector, isDescribeLoaded, getFeatureById, wfsURL, wfsFilter, featureCollectionResultSelector, isSyncWmsActive, featureLoadingSelector} from '../selectors/query';
 ...
 * @memberof epics.featuregrid
 */
export const featureGridUpdateFilter = (action$, store) => action$.ofType(QUERY_CREATE).switchMap( () =>
...
/**
 * Properly resets draw support on create new feature
 */
...
export default featureGridEpics;
