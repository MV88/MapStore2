...
export const getDimensions = function(layer) {
...
export const getCapabilities = function(url, raw) {
    const parsed = urlUtil.parse(url, true);
...
export const describeLayer = function(url, layers, options = {}) {
    const parsed = urlUtil.parse(url, true);
...
export const describeLayers = function(url, layers) {
    const parsed = urlUtil.parse(url, true);
    const describeLayerUrl = urlUtil.format(assign({}, parsed, {
        query: assign({
            service: "WMS",
...
export const parseLayerCapabilities = function(capabilities, layer, lyrs) {
...
export const getBBox = function(record, bounds) {
    let layer = record;
