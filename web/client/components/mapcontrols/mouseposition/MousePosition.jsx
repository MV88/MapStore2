        ...
        if (this.props.enabled) {
            ...
            return (
                    <div id={this.props.id} style={this.props.style}>
                        ...
                        {this.props.editCRS ? <CRSSelector projectionDefs={this.props.projectionDefs} filterAllowedCRS={this.props.filterAllowedCRS} additionalCRS={this.props.additionalCRS} label={this.props.showLabels ? <label><Message msgId="mousePositionCRS"/></label> : null} crs={this.props.crs} enabled onCRSChange={this.props.onCRSChange}/> : null}
