...
const {Panel, ButtonGroup, Tooltip, Glyphicon, Button, Grid, Row, Col, FormGroup, ControlLabel, Form} = require('react-bootstrap');
            ...
            <div>
                <Form horizontal>
                    ...
                    {this.props.lineMeasureEnabled && (<Row>
                        <FormGroup>
                            <Col xs={6}>
                                <ControlLabel>Formula for length calculation</ControlLabel>
                            </Col>
                            <Col xs={6}>
                                <DropdownList
                    ...
                    <Row>
                        <FormGroup>
                            <Col xs={12}>
                                <Button disabled={this.props.showResults && !(this.props.measurement.feature)} onClick={() => {}}>Add as annotations</Button>
                            </Col>
                        </FormGroup>
                    </Row>
                </Form>
