...
import { areDetailsActive } from '../../../../utils/RulesEditor';
export default ({layer, rule = {}, onNavChange = () => {}, onExit = () => {}, disableSave = true, disableDetails = false, onSave = () => {}, activeTab = "1", loading = false, type = ""}) => {
    const buttons = [{
        glyph: '1-close',
