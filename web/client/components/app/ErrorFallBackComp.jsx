...
const ErrorBoundaryFallbackComponent = ({componentStack, error, prod = false}) => {
    ...
    return (<div style={style}>
        ...
        <p>Please contact us to our <a target="_blank" href="https://groups.google.com/forum/#!forum/mapstore-users">mailing list</a>, or check for an issue <a target="_blank" href="https://github.com/geosolutions-it/MapStore2/issues">here</a></p>
