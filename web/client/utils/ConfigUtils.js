...
const centerPropType = PropTypesLib.shape({
    x: PropTypesLib.number.isRequired,
    y: PropTypesLib.number.isRequired,
    crs: PropTypesLib.string
});
...
let defaultConfig = {
    // TODO: these should be changed to relative paths, without /mapstore/ or / (to avoid the needing of overriding in default cases)
...
export const defaultSourceType = "gxp_wmssource";
export const backgroundGroup = "background";

export const PropTypes = {
    center: centerPropType,
    config: PropTypesLib.shape({
        center: centerPropType,
        zoom: PropTypesLib.number.isRequired
    }),
    mapStateSource: PropTypesLib.string
};
...
export const setLocalConfigurationFile = (file) => {
...
export const getCenter = (center, projection) => {
...
export const convertFromLegacy = (config) => {
 ...
 */
export const copySourceOptions = (layer, source) => {
 ...
 */
export const setupLayers = (layers, sources, supportedSourceTypes) => {
...
export const setConfigProp = (prop, value) => {
    defaultConfig[prop] = value;
};
export const removeConfigProp = (prop) => {
