...
import {isString, trim, isNumber, pick, get, find, mapKeys, mapValues, keys, uniq, uniqWith, isEqual, isEmpty, findIndex, cloneDeep} from 'lodash';
 ...
 *   - `crs`: crs of the extent
 export *   - `maxZoom`: max zoom for the zoom to functionality.
...
export function saveMapConfiguration(currentMap, currentLayers, currentGroups, currentBackgrounds, textSearchConfig, additionalOptions) {
